...
export const th: Translation = {
	...
	[Key.sponsorBanner]: "สนับสนุนบล็อกนี้",
	[Key.sponsorDescription]:
		"หากเนื้อหาของฉันเป็นประโยชน์ต่อคุณ สามารถสนับสนุนได้ผ่านช่องทางด้านล่าง การสนับสนุนของคุณคือแรงบันดาลใจในการสร้างสรรค์ต่อไป!",
	[Key.sponsorUsage]:
		"การสนับสนุนจะนำไปใช้ดูแลเซิร์ฟเวอร์ สร้างเนื้อหา และพัฒนาฟีเจอร์ เพื่อให้ได้เนื้อหาคุณภาพดีอย่างต่อเนื่อง",
	[Key.sponsorScan]: "สแกนด้วย {name} เพื่อสนับสนุน",
	[Key.sponsorLinkBy]: "สนับสนุนผ่าน {name}",
	[Key.sponsorVisit]: "ไปสนับสนุน",
	[Key.sponsorList]: "รายชื่อผู้สนับสนุน",
	[Key.sponsorEmpty]: "ยังไม่มีรายการสนับสนุน มาเป็นผู้สนับสนุนคนแรกกันเถอะ!",
	[Key.friendsCount]: "ลิงก์",
	[Key.friendsCounts]: "ลิงก์",
	[Key.friendGuideApply]: "ขอแลกลิงก์",
	[Key.friendGuideNotes]: "ข้อควรทราบ",
	[Key.friendFieldSiteName]: "ชื่อเว็บ",
	[Key.friendFieldSiteDesc]: "คำอธิบายเว็บ",
	[Key.friendFieldSiteUrl]: "ลิงก์เว็บ",
	[Key.friendFieldAvatar]: "ลิงก์รูปโปรไฟล์",
	[Key.friendStep1Title]: "เพิ่มลิงก์เว็บนี้",
	[Key.friendStep1Desc]:
		"เพิ่มข้อมูลเว็บนี้ลงหน้าลิงก์เพื่อนของคุณก่อน แล้วคัดลอกข้อมูลแต่ละช่องด้านซ้ายได้เลย",
	[Key.friendStep2Title]: "ฝากคอมเมนต์",
	...
	[Key.friendContactHeading]: "ติดต่อฉันได้ผ่านช่องทางเหล่านี้",
	...
	[Key.moreMoments]: "ดูโมเมนต์เพิ่มเติม",
	...
	[Key.advertisement]: "โฆษณา",
	[Key.advertisementClose]: "ปิดโฆษณา",
	...
	[Key.siteInfo]: "ข้อมูลไซต์",
	[Key.siteInfoPlatform]: "แพลตฟอร์ม",
	[Key.siteInfoVersion]: "เวอร์ชัน",
	[Key.siteInfoLicense]: "สัญญาอนุญาต",
	[Key.siteInfoDomain]: "โดเมน",
	[Key.siteInfoAstro]: "Astro",
	[Key.siteInfoNode]: "Node",
	[Key.siteInfoPnpm]: "pnpm",
	[Key.siteInfoSystem]: "ข้อมูลระบบ",
	[Key.siteInfoBuiltAt]: "วันที่บิลด์",
	[Key.siteInfoMore]: "ดูรายละเอียดเพิ่มเติม",
	[Key.siteInfoLess]: "ย่อรายละเอียด",
	...
	[Key.wallpaperModeFullscreen]: "เต็มหน้าจอ",
	[Key.wallpaperModeOverlay]: "ซ้อนทับ",
	[Key.settingsTabAppearance]: "รูปลักษณ์",
	[Key.settingsTabWallpaper]: "ภาพพื้นหลัง",
	[Key.settingsTabEffects]: "เอฟเฟกต์",
	[Key.fullscreenLayout]: "เลย์เอาต์แบบเต็มหน้าจอ",
	[Key.fullscreenLayoutClassic]: "คลาสสิก",
	[Key.fullscreenLayoutHero]: "ฮีโร่",
	[Key.overlaySettings]: "ตั้งค่าความโปร่งใส",
	[Key.overlayOpacity]: "ความทึบของภาพพื้นหลัง",
	[Key.overlayBlur]: "ความเบลอของพื้นหลัง",
	[Key.overlayCardOpacity]: "ความทึบของการ์ด",
	[Key.wallpaperSettings]: "ตั้งค่าภาพพื้นหลัง",
	[Key.wallpaperTitle]: "ชื่อเรื่องภาพพื้นหลังหน้าแรก",
	[Key.wallpaperCarousel]: "ภาพพื้นหลังแบบเลื่อน",
	[Key.wavesAnimation]: "แอนิเมชันคลื่น",
	[Key.gradientTransition]: "การไล่เฉดสี",
	[Key.sakuraEffect]: "เอฟเฟกต์ซากุระ",
	[Key.backgroundVideo]: "วิดีโอพื้นหลัง",
