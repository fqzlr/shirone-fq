...
export const ja: Translation = {
	...
	[Key.friendGuideApply]: "フレンド申請",
	[Key.friendGuideNotes]: "注意事項",
	[Key.friendFieldSiteName]: "サイト名",
	[Key.friendFieldSiteDesc]: "サイトの説明",
	[Key.friendFieldSiteUrl]: "サイトURL",
	[Key.friendFieldAvatar]: "アバターURL",
	[Key.friendStep1Title]: "当サイトへのリンクを追加",
	[Key.friendStep1Desc]:
		"まずお使いのサイトのリンク集に当サイトを追加してください。左側の各項目をコピーしてご利用いただけます",
	[Key.friendStep2Title]: "コメントを送信",
	[Key.friendStep2Desc]:
		"申請テンプレートをコピーして編集し、下のコメント欄に送信してください",
	[Key.friendStep3Title]: "審査待ち",
	[Key.friendStep3Desc]: "情報を確認でき次第、できるだけ早くリンクを追加します",
	[Key.friendContactHeading]: "連絡先",
	...
	[Key.wallpaperModeFullscreen]: "フルスクリーン",
	[Key.wallpaperModeOverlay]: "オーバーレイ",
