...
export const zh_CN: Translation = {
	...
	[Key.guestbook]: "留言板",
	[Key.guestbookBanner]: "欢迎在这里留下你的足迹。",
	[Key.friendsCount]: "个友链",
	[Key.friendsCounts]: "个友链",
	[Key.friendGuideApply]: "申请友链",
	[Key.friendGuideNotes]: "注意事项",
	[Key.friendFieldSiteName]: "站点名称",
	[Key.friendFieldSiteDesc]: "站点描述",
	[Key.friendFieldSiteUrl]: "站点链接",
	[Key.friendFieldAvatar]: "头像链接",
	[Key.friendStep1Title]: "添加本站友链",
	[Key.friendStep1Desc]:
		"请先在您的网站友链页面添加本站信息，可直接复制左侧各字段",
	[Key.friendStep2Title]: "评论区留言",
	[Key.friendStep2Desc]: "把申请模板复制修改后，到下方评论区发送即可",
	[Key.friendStep3Title]: "等待审核",
	[Key.friendStep3Desc]: "确认信息无误后会尽快添加您的友链",
	[Key.friendContactHeading]: "联系方式",
	...
	[Key.wallpaperModeFullscreen]: "全屏壁纸",
	[Key.wallpaperModeOverlay]: "覆盖透明",
