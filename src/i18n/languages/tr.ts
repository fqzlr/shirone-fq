...
export const tr: Translation = {
	...
	[Key.friendGuideApply]: "Arkadaş Bağlantısı Başvurusu",
	[Key.friendGuideNotes]: "Notlar",
	[Key.friendFieldSiteName]: "Site adı",
	[Key.friendFieldSiteDesc]: "Site açıklaması",
	[Key.friendFieldSiteUrl]: "Site bağlantısı",
	[Key.friendFieldAvatar]: "Avatar bağlantısı",
	[Key.friendStep1Title]: "Sitemizin bağlantısını ekleyin",
	[Key.friendStep1Desc]:
		"Önce site bilgilerini arkadaş sayfanıza ekleyin; soldaki alanları kopyalayabilirsiniz",
	[Key.friendStep2Title]: "Yorum bırakın",
	[Key.friendStep2Desc]:
		"Başvuru şablonunu kopyalayıp düzenleyin ve aşağıdaki yorumlara gönderin",
	[Key.friendStep3Title]: "İncelemeyi bekleyin",
	[Key.friendStep3Desc]:
		"Bilgiler doğrulandıktan sonra bağlantınız en kısa sürede eklenecektir",
	[Key.friendContactHeading]: "İletişim",
	...
	[Key.advertisementClose]: "Reklamı Kapat",
	[Key.advertisement]: "Reklam",
	...
	[Key.wallpaperModeOverlay]: "Kaplama",
	[Key.settingsTabAppearance]: "Görünüm",
	[Key.settingsTabWallpaper]: "Duvar kağıdı",
	[Key.settingsTabEffects]: "Efektler",
	[Key.fullscreenLayout]: "Tam ekran düzeni",
	[Key.fullscreenLayoutClassic]: "Klasik",
	[Key.fullscreenLayoutHero]: "Kahraman",
	[Key.overlaySettings]: "Şeffaflık ayarları",
	[Key.overlayOpacity]: "Duvar kağıdı opaklığı",
	[Key.overlayBlur]: "Arka plan bulanıklığı",
	[Key.overlayCardOpacity]: "Kart opaklığı",
	[Key.wallpaperSettings]: "Duvar kağıdı ayarları",
	[Key.wallpaperTitle]: "Ana sayfa duvar kağıdı başlığı",
	[Key.wallpaperCarousel]: "Duvar kağıdı atlıkarınca",
